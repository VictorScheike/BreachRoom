...
export const NORTHSTAR_ZERO_HOUR_QUESTIONS: Question[] = [
  ...
  q(
    ...
    "IT support, a warehouse shift lead, and a confident agency worker all believe they are running the morning. The agency worker has a megaphone and a slide titled incident room, draft. Decisions are travelling by shout.",
    "I have slides. Someone has to take control of the floor.",
    "How should command of this incident be organised?",
    ["NIST IR", "DORA"],
    [
      o("zh-e01-a", "high-risk", "Let the loudest voice win", "Authority follows volume.", [0, 0, 0], "Contradictory orders hit the floor: isolate, do not isolate, reboot.", "Authority needs a name, not volume.", recEscLead, "One voice out, one log in.", "Unclear command creates three containments and zero decisions.", "The megaphone issues a third, conflicting instruction."),
      o("zh-e01-b", "strong", "Name a coordinator, a technical lead, and a scribe", "Roles, not volume. The agency worker can still take notes.", [3, 2, 3], "People know where facts go and who can say stop.", "Coordination is an appointment, not a vibe.", recEscLead, "This unblocks every later choice.", "Someone must own the clock. That someone is assigned, not assumed.", "Roles are posted. The agency worker becomes scribe and the shouting stops."),
